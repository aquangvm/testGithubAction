...
public interface IDocInternalRepository extends IRepository<DocumentInternal> {
	...
	@Query("SELECT new com.vz.backend.business.dto.document.DocInternalForListDto(d1.id, d1.numberOrSign, d1.preview, d1.status, d1.createBy, d1.createUser.fullName, d1.createDate, d1.approveDate, d1.read) "
