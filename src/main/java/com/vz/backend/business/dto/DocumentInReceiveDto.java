...
public class DocumentInReceiveDto {
	...
	public DocumentInReceiveDto(Documents doc) {
		...
		this.orgTransfer = (doc.getOrgTransfer() != null) ?
				(doc.getOrgTransfer().getParentOrg() != null) ?
						doc.getOrgTransfer().getParentOrg().getName() + ", " + doc.getOrgTransfer().getName() :
						doc.getOrgTransfer().getName() : "";
